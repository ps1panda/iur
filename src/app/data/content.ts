...
export const partners = [
  { name: "Аптеки Горздрав", image: "/partners/gor.svg" },
  { name: "Wildberries", image: "/partners/wildberries__.png" },
  { name: "OZON", image: "/partners/ozon.svg" },
  { name: "Fix Price", image: "/partners/fix.svg" },
  { name: "Четыре Лапы", image: "/partners/4lapy.svg" },
  { name: "Пятёрочка", image: "/partners/pyaterochka__.svg" },
