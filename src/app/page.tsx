      ...
      <main>
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(120deg, rgba(4, 13, 31, 0.78), rgba(6, 22, 55, 0.65)), url('https://images.unsplash.com/photo-1479839672679-a46483c0e7c8?auto=format&fit=crop&w=2000&q=80')",
